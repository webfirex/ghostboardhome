...
export default function FaqSection() {
    return (
        <div className="flex flex-col items-center w-full my-7 bg-[url(/com4-bg.png)] bg-no-repeat bg-contain sm:bg-cover bg-top min-h-screen">
            
            <div className="flex flex-col sm:flex-row w-full max-w-[1500px] pt-7 px-3 justify-start items-start flex-wrap">
                
                <div className="flex flex-col w-full sm:w-1/3 justify-between items-start z-10 gap-7 bg-white h-fit rounded-xl p-7">
                    <div className="flex flex-col items-start w-full gap-1">
                        ...
                        <div className="flex gap-4 justify-center items-center mt-12 flex-wrap">
                            <Link href={'https://ghostboard.net/auth/sign-up'}><RainbowButton className=" text-white !font-light hover:scale-[1.02] transition-all py-7 px-14 text-nowrap"> Register Now </RainbowButton></Link>
