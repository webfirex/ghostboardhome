...
import { avatars, testimonials } from "@/data/modules";
            ...
            <div className="flex w-full max-w-[1500px] pt-14 px-3 justify-center items-center flex-wrap bg-transparent">
                ...
                <div className="flex flex-col w-full px-3 justify-center items-center z-10">
                    ...
                    <div className="flex gap-4 justify-center items-center">
                        <Link href={'https://ghostboard.net/auth/sign-up'}><RainbowButton className=" text-white !font-light hover:scale-[1.02] transition-all py-7 px-14">✨ Register Now ✨</RainbowButton></Link>
                    </div>
                </div>
